      ...
      <div className="flex-1 flex flex-col lg:flex-row">
        ...
        <div className="lg:w-[40%] shrink-0 p-5 lg:p-8 lg:sticky lg:top-0 lg:h-screen flex flex-col border-b lg:border-b-0 lg:border-r border-black/[0.06]">
          ...
          <p className="text-sm text-neutral-500 mt-3 leading-relaxed">
            Une question sur les données ? Une suggestion ? Un bug ? Ce formulaire arrive directement dans ma boîte mail.
          </p>
          <a
            href="https://linkedin.com/in/florentbertiaux"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 mt-5 bg-[#0A66C2] text-white rounded-2xl px-4 py-2.5 text-sm font-semibold hover:bg-[#0958a8] transition-colors self-start"
          >
        ...
        <div className="flex-1 p-5 lg:p-8 flex flex-col">
          ...
          <PageFooter className="px-0 mt-8" />
        </div>
      </div>
    </div>
  )
